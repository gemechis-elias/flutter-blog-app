...
import 'package:blog_app/features/blog/data/datasources/local_data_source.dart';
...
Future<void> init() async {
  ...
  sl.registerFactory(
      () => AddBookmarkUseCase(sl())); // << added bookmark use case here
  sl.registerFactory(() =>
      GetBookmarkUseCase(sl())); // << added get all bookmark use case here
