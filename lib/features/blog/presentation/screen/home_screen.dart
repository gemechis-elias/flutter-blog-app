...
import 'package:blog_app/features/blog/presentation/widgets/live_search.dart';
...
import '../../../user/presentation/blocs/bloc.dart';
import '../../../user/presentation/blocs/bloc_state.dart';
import '../../../user/presentation/blocs/get_user.dart/user_event.dart';
import '../../../user/presentation/blocs/get_user.dart/user_state.dart';
...
class _HomeState extends State<Home> {
  ...
  String fullName = '';
  String profile_photo = "assets/images/no_profile.png";
            ...
            Container(
              ...
              child: GestureDetector(
                ...
                child: profile_photo != null &&
                        Uri.parse(profile_photo!).isAbsolute
                    ? ClipOval(
                        child: Image.network(
                          profile_photo!,
                          width: 42,
            ...
            children: [
              ...
              StreamBuilder<String>(
                ...
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    return TagSelector(tag: tags[_currentPage]);
                  }

                  String searchKeyword = snapshot.data!;
                  List<Article> filteredArticles =
                      filterArticlesByKeyword(searchKeyword);

                  return LiveSearch(title: snapshot.data!);
                },
              ),
            ],
          ),
  ...
  List<Article> filterArticlesByKeyword(String keyword) {
    // Implement your filtering logic here based on the keyword
    // Return the filtered list of articles
    // You might need to call setState() here if your filtering involves state changes
    return [];
  }
