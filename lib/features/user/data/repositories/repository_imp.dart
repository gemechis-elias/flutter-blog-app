...
import 'package:blog_app/features/user/data/models/user_model.dart';
...
class UserRepositoryImpl implements UserRepository {
  ...
  @override
  Future<Either<Failure, User>> updateProfilePhoto(File userData) async {
    print(
        "success repo  change profile data repo change profile data repo change profile data repo  change profile data repo  change profile data repo change profile data repo   ${userData}");
    try {
      print("change profile data repo");
      final user = await remoteDataSource.updateProfilePhoto(userData);
      return Right(user); // Return success as Right with null value
    } catch (e) {
      print(" faulur change profile data repo change  ${userData}");
